      ...
      <div className="container mx-auto max-w-7xl px-4">
        ...
        <div className="flex nowhitespace space-x-5 rounded-xl bg-white p-1 overflow-x-auto mb-4">
          ...
          <button
            ...
            className={`px-4 py-2 rounded-t-lg transition-all duration-300 hidden sm:block hover:cursor-pointer
    ${
      selectedButton === "dek"
        ? "bg-green-50 text-green-700 font-semibold border-b-4 border-green-600"
